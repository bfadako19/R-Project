...
# the data values put into a vector must be of the same data type
...
# uae the matrix function to create a matrix
...
# the data frame is a 2 dimensional collection that can have vectors
# of different data types, but the vectors must all be of the same length
...
# musr use as.data.frame to create data frame
df <- as.data.frame(cbind(vnumeric,vcharacter,vlogical))
df

# the list is one of the most robust and flexible data structures
# in R because the data values in them may be any data type and 
# data structures in them may be of any length
