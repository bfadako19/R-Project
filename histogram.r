...
# get documentation on histogram function
?hist
...
# y-axis is telling us the number of data points in each sepal length
...
# when observing anomolies in the data, like outlier data, it comes in
# handy to group your plots together

# the par function may be used to group plots together
# the par function changes the graphic default parameters
# get documentation on par
?par

# get documentation on the concatenate function(combines arguments)
?c
...
# inside the square brackets, we include a selector that specifies
...
# restore graphic default parameters so that the graphs are 
# no longer grouped
par(mfrow = c(1,1))
